...
def UCB_swap(args, imgs, sigma, init_medoids, dist_mat = None, cache_computed = None):
    ...
    return medoids, S_logstring, iter, loss, closest_medoids
...
def UCB_build_and_swap(args):
    ...
    if 'S' in args.build_ao_swap:
        ...
        swapped_medoids, S_logstring, num_swaps, final_loss, closest_medoids = UCB_swap(args, imgs, sigma, init_medoids, dist_mat = dist_mat, cache_computed = args.cache_computed)
